...
namespace qs {
    ...
    */
    typedef  class qs_type qs_typeKeyHolder;

    #define qs_typePlugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
    #define qs_typePlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
    #define qs_typePlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

    #define qs_typePlugin_get_key PRESTypePluginDefaultEndpointData_getKey 
    #define qs_typePlugin_return_key PRESTypePluginDefaultEndpointData_returnKey

    #define qs_typePlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
    #define qs_typePlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

    /* --------------------------------------------------------------------------------------
    Support functions:
    * -------------------------------------------------------------------------------------- */

    NDDSUSERDllExport extern qs_type*
    qs_typePluginSupport_create_data_w_params(
        const struct DDS_TypeAllocationParams_t * alloc_params);

    NDDSUSERDllExport extern qs_type*
    qs_typePluginSupport_create_data_ex(RTIBool allocate_pointers);
    ...
    qs_typePluginSupport_destroy_data_w_params(
        qs_type *sample,
        const struct DDS_TypeDeallocationParams_t * dealloc_params);

    NDDSUSERDllExport extern void 
    qs_typePluginSupport_destroy_data_ex(
        qs_type *sample,RTIBool deallocate_pointers);
    ...
    NDDSUSERDllExport extern void 
    qs_typePluginSupport_print_data(
        const qs_type *sample,
        const char *desc,
        unsigned int indent);

    NDDSUSERDllExport extern qs_type*
    qs_typePluginSupport_create_key_ex(RTIBool allocate_pointers);

    NDDSUSERDllExport extern qs_type*
    qs_typePluginSupport_create_key(void);

    NDDSUSERDllExport extern void 
    qs_typePluginSupport_destroy_key_ex(
        qs_typeKeyHolder *key,RTIBool deallocate_pointers);
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    NDDSUSERDllExport extern RTIBool 
    qs_typePlugin_deserialize_key_sample(
        PRESTypePluginEndpointData endpoint_data,
        qs_type * sample,
        struct RTICdrStream *stream,
        RTIBool deserialize_encapsulation,
    ...
    qs_typePlugin_new(void);

    NDDSUSERDllExport extern void
    qs_typePlugin_delete(struct PRESTypePlugin *);
