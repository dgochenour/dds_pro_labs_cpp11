...
#include <dds/core/ddscore.hpp> // LAB #6 -- ADD THIS!!
...
void publisher_main(int domain_id, int sample_count)
{
    ...
    // LAB #6 - use our new qosProvider when creating our entities
    ...
    dds::pub::DataWriter<qs::qs_type> writer(dds::pub::Publisher(participant, qosProvider.publisher_qos()),
                                            topic,
    ...
    for (int count = 0; count < sample_count || sample_count == 0; count++) {
        ...
        // LAB #10 - to support CFT lab, change name so it will not always pass the filter
        if (count % 2 == 0) {
            sample.name("Don Gochenour");
        } else {
            sample.name("Some other dude");
        }
        sample.id(9017); 
        sample.value1(count);
        ...
        // LAB #8 - change sending period to 1Hz)
