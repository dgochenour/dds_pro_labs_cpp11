...
data type SmallType from example.idl.
This example builds two applications, named example_publisher and
example_subscriber.
...
> make -f makefile_example_x64Darwin17clang9.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the example_publisher.cxx
file where it says:
...
Run /Applications/rti_connext_dds-6.1.1/resource/scripts/rtisetenv_x64Darwin17clang9.0.bash
...
> objs/x64Darwin17clang9.0/example_publisher -d <domain_id> -s <sample_count>
> objs/x64Darwin17clang9.0/example_subscriber -d <domain_id> -s <sample_count>
